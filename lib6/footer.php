                  ...
                  <div class="col-sm-6 col-md-3">
                     <div class="widget dark">
                        ...
                        <ul class="list-inline mt-5">
                           ...
                           <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o text-theme-color-2 mr-5"></i> <a class="text-gray" href="#"><span class="__cf_email__" data-cfemail="89eae6e7fde8eafdc9f0e6fcfbede6e4e8e0e7a7eae6e4">[email&#160;protected]</span></a> </li>
                           <li class="m-0 pl-10 pr-10"> <i class="fa fa-globe text-theme-color-2 mr-5"></i> <a class="text-gray" href="#">www.iimbglib.com</a> </li>
                        </ul>
                     </div>
                  </div>
                  <div class="col-sm-6 col-md-3">
                     <div class="widget dark">
                        ...
                        <ul class="list angle-double-right list-border">
                           ...
                           <li><a href="page-course-list">Our Courses</a></li>
                           <li><a href="page-pricing-style1">Pricing Table</a></li>
                           <li><a href="page-gallery-3col">Gallery</a></li>
